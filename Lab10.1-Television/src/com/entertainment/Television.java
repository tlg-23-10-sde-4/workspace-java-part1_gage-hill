...
public class Television {
    ...
    public Television(String brand) throws IllegalArgumentException {
        this();
        setBrand(brand);
    }
     ...
     *   }
     *   else() {
     *       throw new InvalidBrandException(String.format("Invalid volume: %s Must be between %s and %s. \n", brand));
     *   }
     */
    ...
    public void setVolume(int volume) throws IllegalArgumentException {
        if (MIN_VOLUME  <= volume && volume <= MAX_VOLUME) {
            ...
            throw new IllegalArgumentException(String.format("Invalid volume: %s. Must be between %s and %s.|n", volume, MIN_VOLUME, MAX_VOLUME));
        }
    }
