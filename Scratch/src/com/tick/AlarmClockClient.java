 ...
 * It's purpose is to create a few instances of AlarmClock and give them a basic test-drive.
 */
class AlarmClockClient {
    ...
    public static void main(String[] args) {
        ...
        AlarmClock clock2 = new AlarmClock(AlarmClock.MAX_INTERVAL); // as long as it can "className.fieldName"
